                                                                                ...
                                                                                ft.Container(
                                                                                    ...
                                                                                    content = ft.Column( 
                                                                                        controls = [
                                                                                            ...
                                                                                            ft.Text ('TEMPLER', size = 18,text_align="START",weight =ft.FontWeight.W_900,color=ft.Colors.WHITE),
                                                                                            ft.Text ('Lager', size = 12,weight =ft.FontWeight.W_700,color=ft.Colors.WHITE),
                                                                                            ft.Text (f"Lager, amb ingredients del Berguedà\ncereals de Espunyola i llúpol d'Avià\n\nIngredients: Pàmola, Ordi recuperat per pagesia responsable i ecològica.\n\nPendent -- 6.5% Vol. | IBU  70\n", size = 14,color=ft.Colors.WHITE),
                                                                                            ft.Image(fit=ft.ImageFit.CONTAIN,tooltip="Lager",color_blend_mode = 30,height = 250,width = 200,src = "../assets/Templer_F_T.PNG"),
